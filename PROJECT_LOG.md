...
- `/now`
- `/uses`
- `/journal` and `/journal/[slug]` (13 posts)
...
Dates in `src/lib/posts.ts` should look organically spaced. Currently 13 posts spread from `2025-12-15` to `2026-07-09`, roughly every 2 to 3 weeks. When adding a new post, pick a date close to "today" and update this log section if you reshuffle dates.
