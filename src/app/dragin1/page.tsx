...
import { dragin1, dragSources, dragDestinations } from "@/content/dragin1";
...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "drag and drop Outlook web attachment",
  ...
  "@graph": [
    {
      ...
      url: "https://wildtechdev.com/dragin1",
  ...
  return (
    <div>
      ...
      <section className="relative py-16 sm:py-24 overflow-hidden">
        <span className="absolute top-20 left-1/2 -translate-x-1/2 w-[520px] h-[320px] rounded-full bg-green opacity-[0.06] blur-3xl pointer-events-none animate-glow-pulse" />

        <div className="relative max-w-4xl mx-auto px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row sm:items-start gap-8 sm:gap-10">
            <div className="shrink-0 animate-hero-reveal">
              <DragIn1Logo size={104} id="hero" />
            </div>

            <div className="flex-1 min-w-0">
              <div className="flex flex-wrap items-center gap-x-4 gap-y-2 mb-5 animate-fade-in-up">
                <span className="text-[10px] uppercase tracking-[0.2em] text-green font-mono">
                  Free &amp; open source
                </span>
              ...
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-[family-name:var(--font-serif)] italic text-heading leading-[1.05] mb-6 animate-fade-in-up delay-100">
                DragIn1
              </h1>

              <p className="text-body text-lg sm:text-xl leading-relaxed mb-4 animate-fade-in-up delay-200">
      ...
      {/* The problem */}
      <section className="py-16 sm:py-20 border-t border-border bg-[#050505]">
      ...
      <section className="py-16 sm:py-24 border-t border-border">
        <div className="max-w-5xl mx-auto px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-px bg-border mt-px">
            {steps.map((step, i) => (
              <ScrollReveal key={step.n} delay={i * 100}>
                <div className="bg-black p-7 sm:p-8 h-full">
                  <span className="block text-[40px] leading-none font-[family-name:var(--font-serif)] text-border mb-5">
                    {step.n}
                  </span>
                  <h3 className="text-lg font-[family-name:var(--font-sans)] font-bold text-heading mb-3">
                    {step.title}
                  </h3>
          ...
          <ScrollReveal>
            <div className="mt-10 border-l-2 border-green/40 pl-5 py-1">
      ...
      {/* Privacy */}
      <section className="py-16 sm:py-24 border-t border-border bg-[#050505]">
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          <ScrollReveal>
            <div className="relative bg-[#0a0a0a] border border-green/30 p-6 sm:p-10 overflow-hidden">
              <span className="absolute -top-16 -right-16 w-[280px] h-[280px] rounded-full bg-green opacity-[0.07] blur-3xl pointer-events-none" />
      ...
      <section className="py-16 sm:py-24 border-t border-border">
        <div className="max-w-5xl mx-auto px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-px bg-border">
            <ScrollReveal>
              <div className="bg-black p-7 sm:p-8 h-full">
                <p className="text-[10px] uppercase tracking-[0.2em] text-green font-mono mb-6">
                  Drag from
                </p>
                <ul className="space-y-4">
                  {dragSources.map((s) => (
                    <li key={s.name} className="flex items-start gap-3">
                      <span className="w-1 h-1 bg-green rounded-full shrink-0 mt-2.5" />
                      <span>
            ...
            <ScrollReveal delay={100}>
              <div className="bg-black p-7 sm:p-8 h-full">
                <p className="text-[10px] uppercase tracking-[0.2em] text-muted font-mono mb-6">
                  Drop onto
                </p>
                <ul className="space-y-4">
                  {dragDestinations.map((d) => (
                    <li key={d.name} className="flex items-start gap-3">
                      <span className="w-1 h-1 bg-border rounded-full shrink-0 mt-2.5" />
                      <span>
                        <span className="block text-sm text-heading font-[family-name:var(--font-sans)]">
                          {d.name}
                        </span>
        ...
        <div className="max-w-3xl mx-auto px-6 lg:px-8">
          ...
          <ScrollReveal>
            <p className="text-sm text-body mt-10">
              Still stuck?{" "}
              <Link href="/dragin1/support" className="text-green link-underline">
        ...
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          <ScrollReveal>
            <div className="bg-black border border-border p-6 sm:p-10">
              <p className="text-[10px] uppercase tracking-[0.2em] text-muted font-mono mb-5">
                One product family
              </p>
